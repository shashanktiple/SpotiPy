...
def lambda_handler(event, context):
    ...
    for file in (s3.list_objects(Bucket = Bucket, Prefix = Key)['Contents']):
        ...
        if file_key.split('.')[-1] == 'json':
            resource = s3.get_object(Bucket = Bucket, Key = file_key)
    ...
    for data in spotify_data:
        ...
        #loading data into their respected s3 folders
        #song folder
        ...
        #copying data from S3/to_be_processed to S3/processed
